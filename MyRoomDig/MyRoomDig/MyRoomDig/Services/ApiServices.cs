namespace MyRoomDig.Services
{
    ...
    public class ApiServices
    {
        ...
        public async Task<Response> PostList<T>(string urlBase, string servicePrefix, string controller, List<T> model)
        {
            try
            {
                var request = JsonConvert.SerializeObject(model, Formatting.Indented);
        ...
        public async Task<TokenResponseModel> GetToken(
            string urlBase,
            string username,
            string password)
        {
